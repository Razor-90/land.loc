...
<div class="form-group">
    	{!! Form::hidden('id', $data['id']) !!}
	     {!! Form::label('filter', 'Название:',['class'=>'col-xs-2 control-label']) !!}
	     <div class="col-xs-8">
		 	{!! Form::text('filter', $data['filter'], ['class' => 'form-control','placeholder'=>'Введите название страницы']) !!}
		 </div>
    </div>    
    ...
    <div class="form-group">
    	...
    	<div class="col-xs-offset-2 col-xs-10">
			{!! Html::image('assets/img/'.$data['img'],'',['class'=>'img-circle img-responsive','width'=>'150px']) !!}
